...
from lafeier.descriptor import FieldDescriptor
from lafeier.htmlpage import HtmlPageRegion
from lafeier.extraction.similarity import (
    similar_region, longest_unique_subsequence, common_prefix)
from lafeier.extraction.pageobjects import (
...
class BasicTypeExtractor(object):
    ...
    For example:
    >>> from lafeier.lafeier.pageparsing import parse_strings
...
class RecordExtractor(object):
    ...
    def extract(self, page, start_index=0, end_index=None, ignored_regions=None, **kwargs):
        """extract data from an lafeier page
    ...
    def _doextract(self, page, extractors, start_index, end_index, nested_regions=None, ignored_regions=None, **kwargs):
        """Carry out lafeier of records using the given annotations
...
class TraceExtractor(object):
    ...
    trace of the lafeier process to aid debugging
    """
