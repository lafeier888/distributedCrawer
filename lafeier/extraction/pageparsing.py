...
from lafeier.htmlpage import HtmlTagType, HtmlTag, HtmlPage
from lafeier.extraction.pageobjects import (AnnotationTag,
...
def parse_strings(template_html, extraction_html):
    """Create a template and lafeier page from raw strings
...
class ExtractionPageParser(InstanceLearningParser):
    """Parse an HTML page for lafeier using the instance based learning
    algorithm
